...
export default class Matrix4 {
    ...
    setLookAt(position, target, up) {
        ...
        elements[2] = -helpVector3.x;
        elements[6] = -helpVector3.y;
        elements[10] = -helpVector3.z;

        helpVector3.product(up).normalize();
        
        elements[0] = helpVector3.x;
        elements[4] = helpVector3.y;
        elements[8] = helpVector3.z;

        helpVector3.product(tmp);

        
        elements[1] = helpVector3.x;
        elements[5] = helpVector3.y;
        elements[9] = helpVector3.z;
        ...
        return this.nextTranslate(helpVector3.copy(position).mutiply(-1));
    }

    lookAt(position, target, up) {
        return this.multiply(helpMatrix.setLookAt(position, target, up));
    }
